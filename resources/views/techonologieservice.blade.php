            ...
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-32 lg:mr-6 lg:px-20 lg:w-2/3 bg-gray-800">
                    ...
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9 mt-4 text-white">
                        Les acteurs du secteur de la technologie voient leurs opportunités de développement s'accroître
                        et se diversifier. Les nouvelles technologies telles que le cloud (SaaS), l'IA, la blockchain ou
                        l'IoT ouvrent de nouvelles perspectives de croissance et doivent être durables.
                    </p>
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        part de marché des SMACS (Social-Mobile-Analytics-Cloud) dans les logiciels et services
                    </p>
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        CA du marché des services informatiques et du conseil en technologies en France
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        Source : Syntec Numérique
                    </p>
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        de croissance pour les 100 premiers acteurs français du Digital
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        Source : étude NKCCG
                    </p>
            ...
            <div class="lg:mx-24 lg:flex mx-6 lg:mx-0">
                <div class="lg:w-1/2 lg:mr-4">
                    <p class="text-black text-xl  ">
                        Le domaine des technologies est en pleine mutation :
                    ...
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        <li class="flex items-center">
                            ...
                            L'ère du Software as a Service
                        ...
                        <li class="flex items-center mt-6">
                            ...
                            Des innovations au service de la transformation des entreprises
        ...
        <section class=" ">
            ...
            <div class="mx-6 lg:mx-24">
                ...
                <h1 class="lg:text-4xl text-2xl font-serif text-left  text-black">
                    Technologie : la disruption permanente
                </h1>
                ...
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    Les acteurs traditionnels du marché (éditeurs de logiciels, entreprises du hardware, fournisseur de
                    services Internet, entreprises de services du numérique) s’engagent dans une phase de profonde
                    transformation. Les logiciels, auparavant vendus comme des produits, deviennent des services (SaaS)
                    dont les fonctionnalités sont dématérialisées dans le cloud.
                </p>
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    Dans le même temps, les logiciels, combinés aux technologies numériques, permettent le développement
                    de nouveaux services, toujours plus spécifiques et intégrés. Ces nouveaux acteurs émergent notamment
                    sous la forme de plateformes (Uber, BlaBlaCar).
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">
                    Des acteurs novateurs

                </h1>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    Vecteur clé de la transformation des entreprises, l’innovation technologique engage tous les acteurs
                    à adapter leur modèle et leur culture. Gestion, exploitation, sécurisation matérielle et juridique
                    des données des clients, création de nouveaux métiers et services, définition de stratégies de
                    pricing adaptées sont les clés d’une transformation réussie. Les acteurs traditionnels de
                    l’industrie technologique sont concernés et privilégient les acquisitions afin d’accélérer leur
                    transformation digitale.
                </p>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    Les usages des nouvelles technologies sont de plus en plus concrets et rentables pour la vie
                    économique, assurant des retours sur investissements rapides aux grands projets de R&D. Le cadre
                    français favorise ces investissements en R&D, notamment grâce au Crédit d'Impôt Recherche (CIR).
                </p>
            ...
            <div class="flex mx-6 lg:h-44 lg:mx-64 ">
                ...
                <div class="ml-6">
                    ...
                    <a href="/contact" class="flex  gi lg:mt-4 lg:ml-4  text-white lg:text-3xl  text-xl block">
                        <span class=""> Comment les entreprises peuvent tirer partie de la 5G ?</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
