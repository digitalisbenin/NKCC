    ...
    <main>
        ...
        <section class="lg:w-1/2 lg:mx-8 mx-6">
            ...
            <div>
                ...
                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">L’avenir des organisations
                    ne
        ...
        <section class=" lg:py-10">
            ...
            <div class=" bg-gray-100 dark:bg-blacksection dark:border-strokedark  lg:py-10">
                ...
                <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-8 mx-6 py-1 lg:px-10 mb-5  ">Assurer sa
                ...
                <div class="mx-6 lg:mx-12 mt-5 lg:flex ">
                    ...
                    <div class=" lg:w-2/3">
                        <div class=" mt-5">
                            <h3 class="lg:text-4xl text-2xl font-bold text-gray-800 mb-5 lg:mx-7">Intégrer les aspects
                                RSE dans sa
                                stratégie</h3>
                            ...
                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-4">L’entreprise
                                compétitive
        ...
        <section class="">
            ...
            <div class=" ">
                ...
                <h1 class="lg:text-4xl text-2xl text-gray-800 mx-5 lg:mb-5 lg:ml-20 leading-relaxed  tracking-wide">
                    Anticiper et faire
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-12 mx-6 ">
                    <div class="lg:mr-6 mt-5 ">
                        ...
                        <div class=" lg:mt-15">
                            ...
                            <P class="text-gray-800 mb-5 leading-relaxed  tracking-wide lg:mx-8 text-xl">C’est donc
                                vers
                        ...
                        <div class=" lg:mt-15">
                            ...
                            <P class="text-gray-800 mb-5 leading-relaxed  tracking-wide lg:mx-8 text-xl">Pour maximiser
                                la
