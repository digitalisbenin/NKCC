...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        ...
        <section class=" py-10">
            <h1 class=" leading-relaxed lg:text-4xl text-2xl lg:ml-10 mx-6 lg:mx-0 mb-5 text-gray-800">Un
                accompagnement quelque soit votre <br>
        ...
        <section class=" lg:py-10">
            ...
            <div class=" bg-gray-100 dark:bg-blacksection dark:border-strokedark  lg:py-10">
                ...
                <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-8  mx-6 py-1 lg:px-10 mb-5   ">Accompagner les ETI
                ...
                <div class=" lg:mx-12 mx-6 lg:mt-5 lg:flex ">
                    ...
                    <div class=" lg:w-2/3">
                        <div class=" mt-5">
                            <h3 class="lg:text-4xl text-2xl font-bold text-gray-800 mb-5 lg:mx-7">Concevoir des
                                business models à
                                l’épreuve des disruptions</h3>
                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-8">De l’adaptation de
                                votre
        ...
        <section class=" lg:py-10 mt-4 lg:mt-0">
            <h1 class=" lg:text-4xl text-2xl mx-6 lg:mx-0 lg:ml-10 text-gray-800">ETI : comment vous aider à créer de
                la <br> confiance et mener
