    ...
    <main>
        ...
        <section class="lg:w-1/2 lg:mx-8 mx-6">
            ...
            <div>
                ...
                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">La pandémie de Covid-19,
                    en
        ...
        <section class="">
            ...
            <div class="py-10 lg:ml-10 mx-6">
                ...
                <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-5 mb-5 ">Construire la confiance grâce à plus de
                    <br> transparence
                </h2>
                ...
                <div class=" mb-6 lg:flex lg:mx-12 ">
                    <div class="lg:mr-6 mt-5 lg:w-1/2 ">
                        ...
                        <div class=" mt-1">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-5 lg:mx-7">Communiquer avec transparence
                            </h3>
        ...
        <section class=" py-10">
            ...
            <div class=" bg-gray-100 dark:bg-blacksection dark:border-strokedark  py-10">
                ...
                <h2 class="lg:text-4xl text-xl text-gray-800 lg:mx-8 py-1 lg:px-10 mb-5 mx-6 ">Assurer sa
                    transformation et sa résilience
                ...
                <div class=" lg:mx-12 mt-5 lg:flex ">
                    ...
                    <div class=" lg:w-2/3">
                        <div class=" mt-5">
                            <h3 class="lg:text-4xl text-2xl font-bold text-gray-800 mb-5 mx-6 lg:mx-7">Simuler les
                                risques pour mieux
                                anticiper</h3>
