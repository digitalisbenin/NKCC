            ...
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-32 lg:mr-6 lg:px-20 lg:w-2/3 bg-gray-800">
                    ...
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9  text-white">
                        ...
                        Face aux nombreux changements réglementaires, l’émergence de nouvelles technologies et de
                        nouveaux acteurs, le secteur bancaire doit adapter, faire évoluer son offre, repenser
                        l’expérience client et revoir ses dispositifs de gestion des risques et de conformité tout en
                        préservant sa solidité financière.
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        des acteurs financiers envisagent de former leurs équipes aux nouvelles compétences du marché
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        des acteurs financiers investissent dans une technologie pour lutter contre la cybercriminalité
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        Source : étude NKCCG
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        de paiements sans contact par seconde en France
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        Source : étude NKCCG
                    </p>
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2">
                    <p class="text-black text-xl  ">
                        Nouvelles technologies, revenus sous pression, concurrence sur les marchés, les acteurs
                        bancaires
                        renouvellent leurs processus et leur travail.
                    </p>
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        ...
                        <li class="flex items-center mt-6">
                            ...
                            Une rentabilité et solidité du secteur
                        </li>
                    </ul>
        ...
        <section class=" ">
            ...
            <div class=" lg:mx-24 mx-6">
                ...
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    La crise financière a conduit à une avalanche règlementaire sans précédent pour le secteur bancaire.
                    Les banques font face à la nécessité de renforcer leur solidité financière, d’améliorer leur
                    dispositif de gestion de risques et de promouvoir des standards en matière d’éthique et de
                    conformité. Bien que l’agenda réglementaire post-crise soit bien avancé, des investissements
                    importants continuent d’être nécessaires pour que chaque acteur puisse faire face aux évolutions
                    réglementaires continues, pérenniser et optimiser les dispositifs mis en œuvre, contenir les coûts
                    croissants de la réglementation et les transformer en opportunité pour le développement de ses
                    activités.
                </p>
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">
                    Le digital, ce nouvel allié
                ...
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    Avec l’émergence de nouvelles technologies et de nouveaux acteurs, le secteur mène une importante
                    transformation digitale : les acteurs bancaires repensent la relation et l’expérience client et
                    développent de nouveaux usages et solutions.
                </p>
                ...
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    La cybercriminalité mobilise davantage les banques qui adaptent leurs dispositifs aux nouvelles
                    menaces et prennent les mesures nécessaires pour détecter et réagir au plus tôt en cas de fraude sur
                    les paiements ou d’attaques sur les systèmes d’information. Pour lutter contre la cybercriminalité,
                    une réponse globale est nécessaire : elle passe par le renforcement des moyens techniques de
                    sécurité des systèmes d’information, des dispositifs de contrôles et de surveillance de l’activité,
                    la formation des collaborateurs, la sensibilisation des clients mais aussi la coopération avec les
                ...
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    Confrontées à une tendance à la baisse de ses revenus (contexte de taux d’intérêt bas, émergence de
                    nouveaux acteurs, évolution consumériste de la réglementation), ainsi qu'à l’accroissement très
                    significatif des coûts de conformité, les marges du secteur bancaire sont sous pression. Pour
                    préserver leur rentabilité les banques optimisent leur modèle opérationnel, repensent le
                    dimensionnement de leurs réseaux bancaires et back offices mais aussi investir dans l’automatisation
                    et la robotisation de leurs processus.
                </p>
                <div class="h-24"></div>
            </div>
        </section>
